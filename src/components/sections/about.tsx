...
export default component$(() => {
  return (
    <section id="about" class="flex min-h-fit flex-col items-center">
      <h2 class="text-4xl bg-white p-2 w-full text-blue-950 text-center font-medium">About</h2>
      <ul class="timeline timeline-vertical timeline-snap-icon max-md:timeline-compact p-3">
        <li>
          ...
          <div class="timeline-start mb-10 md:text-end">
            <time class="font-mono italic">2024 - Present</time>
            <p class="text-lg font-black">MSc Blockchain Technologies</p>
        ...
        <li>
          ...
          <div class="timeline-end mb-10">
            <time class="font-mono italic">11.2023 - 04.2024</time>
            <div class="text-lg font-black">
              Volunteer Lead Developer at 10zyme
            </div>
        ...
        <li>
          ...
          <div class="timeline-start mb-10 md:text-end">
            <time class="font-mono italic">09.2020 - 07.2023</time>
            <div class="text-lg font-black">BCs Computer Science</div>
        ...
        <li>
          ...
          <div class="timeline-end mb-10">
            <time class="font-mono italic">12.2017 - 07.2020</time>
            <div class="text-lg font-black">
              Sports Operator at Betfair Romania Developement
            </div>
